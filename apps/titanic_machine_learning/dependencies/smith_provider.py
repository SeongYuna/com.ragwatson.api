...
from titanic_machine_learning.adapter.outbound.repositories.smith_stats_repository import SmithStatsRepository
...
from titanic_machine_learning.app.use_cases.smith_query_interactor import SmithQueryInteractor
