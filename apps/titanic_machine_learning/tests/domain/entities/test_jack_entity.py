...
from titanic_machine_learning.domain.entities.titanic import TitanicPassenger
from titanic_machine_learning.domain.value_objects.gender_vo import GenderType
