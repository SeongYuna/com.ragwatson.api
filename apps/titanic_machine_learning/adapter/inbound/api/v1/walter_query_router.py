...
from titanic_machine_learning.adapter.inbound.api.dependencies import get_walter_use_case
from titanic_machine_learning.adapter.inbound.api.mappers.walter_query_mapper import (
    table_result_to_responses,
)
from titanic_machine_learning.adapter.inbound.api.schemas.walter_query_schema import (
    WalterReadPassengerResponse,
)
from titanic_machine_learning.app.ports.input.walter_use_case import WalterUseCase
from titanic_machine_learning.adapter.inbound.api.schemas.walter_query_schema import WalterIntroduceResponse
from titanic_machine_learning.app.dtos.walter_dto import WalterIntroduceQuery
