from titanic_machine_learning.adapter.inbound.api.schemas.walter_query_schema import WalterReadPassengerResponse
from titanic_machine_learning.app.dtos.walter_dto import WalterPassengerQuery, WalterTableQueryResult
...
def query_to_response(query: WalterPassengerQuery) -> WalterReadPassengerResponse:
    ...
    return WalterReadPassengerResponse(
        ...
        name=person.name,
        gender=str(Gender.from_raw(person.gender).to_int()),
        age=person.age,
